...
//
        String rootFolder = "crawl-1000";
        String resultFile = "crawled-list-1000.txt";
        crawl(rootFolder, 20, resultFile);
    }

    public static void crawl(String rootFolder, int numberOfCrawlers, String result_file) {
        ...
        try {
             ...
             */
            final List<String> websites = Utils.readFileLineByLine("websites_1.txt");
            int counter = 1;
             ...
             */
            BasicCrawlerFromFile.configure(rootFolder, result_file);
